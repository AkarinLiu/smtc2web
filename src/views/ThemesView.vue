...
import GitThemeDialog from "@/components/GitThemeDialog.vue";
...
async function handleGitInstall(repoUrl: string, branch: string) {
    const success = await themeStore.installFromGit(repoUrl, branch);
    if (success) {
